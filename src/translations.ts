...
export const translations = {
  en: {
    ...
    inventoryExportedBy: 'Inventory exported by',
    ...
    laptopQuantityToExtract: 'Laptop Quantity to Extract',
    selectComponentsToExtract: 'Select Components to Extract',
    availableLaptops: 'Available Laptops',
  ...
  ms: {
    ...
    export: 'Eksport',
    exporting: 'Mengeksport inventori...',
    exportSuccess: 'Inventori berjaya dieksport',
    ...
    laptopQuantityToExtract: 'Kuantiti Komputer Riba untuk Diekstrak',
    selectComponentsToExtract: 'Pilih Komponen untuk Diekstrak',
    availableLaptops: 'Komputer Riba Tersedia',
  ...
  zh: {
    ...
    laptopQuantityToExtract: '要提取的笔记本数量',
    selectComponentsToExtract: '选择要提取的组件',
    availableLaptops: '可用笔记本',
    availableStock: '可用库存',
